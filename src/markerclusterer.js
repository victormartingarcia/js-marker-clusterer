 ...
 *  @return {Array.<google.maps.Marker>} The markers.
 */
MarkerClusterer.prototype.setClustersOpacity = function (opacity) {
    for (var i = 0, cluster; (cluster = this.clusters_[i]); i++) {
        cluster.clusterIcon_.opacity_ = opacity;
        if (cluster.clusterIcon_.div_) {
            cluster.clusterIcon_.div_.style.opacity = opacity;
        }
    }
    for (var i = 0, style; (style = this.styles_[i]); i++) {
        this.styles_[i].opacity = opacity;
    }
};
...
ClusterIcon.prototype.useStyle = function () {
    ...
    this.opacity_ = style['opacity']; //Eladio
...
ClusterIcon.prototype.createCss = function (pos) {
    ...
    var opacity = this.opacity_ ? this.opacity_ : 1;
...
MarkerClusterer.prototype['setClustersOpacity'] = MarkerClusterer.prototype.setClustersOpacity;
